...
set echo on
exec dbms_stats.gather_table_stats(ownname=>user, tabname=>'TC_RESTART', estimate_percent=>null, cascade=>true, method_opt=>'for all columns size 1', no_invalidate=>TRUE);    
set echo off
